  ...
  return (
    <article
      className={cx(
        ...
        accentBorder && "border-l-[4px] border-[#00F5FF]/35"
      )}
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-none flex-col xl:max-w-6xl">
        ...
        <nav className="sticky top-[65px] z-30 hidden border-b border-[#7C3CFF]/20 bg-[#0B1020]/75 px-4 py-2 backdrop-blur-xl md:block md:px-6">
          <div className="flex items-center gap-2">
            {tabs.map((item) => (
              <TabButton
                key={item.id}
        ...
        <main className="flex-1 space-y-4 px-4 pb-28 pt-4 md:space-y-5 md:px-6 md:pb-8 md:pt-5">
          ...
          {tab === "overview" && (
            <>
              ...
              />
              {dispatchMsg && <p className="text-xs font-medium text-[#00F5FF]">{dispatchMsg}</p>}
                          ...
                          {articles.slice(0, 6).length === 0 ? (
                            ...
                            articles.slice(0, 6).map((article) => (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="surface-inset block p-3 transition hover:border-[#00F5FF]/30 hover:bg-[#00F5FF]/6"
                              >
                    ...
                    <div className="mb-3 flex items-center gap-2">
                      ...
                      <div className="rounded-2xl rounded-bl-md border border-white/[0.12] bg-[#111827] px-4 py-3 shadow-sm">
                        <div className="flex gap-1.5">
                          ...
                          <span
                            className="dot-typing h-2 w-2 rounded-full bg-[#00F5FF]/55"
          ...
          {tab === "preferences" && (
            <>
              <Card>
                ...
                {prefsMsg && <p className="mt-3 text-xs font-medium text-[#00F5FF]">{prefsMsg}</p>}
              </Card>
        ...
        <nav
          className="fixed inset-x-0 bottom-0 z-50 border-t border-[#7C3CFF]/25 bg-[#0B1020]/95 px-4 pt-2 backdrop-blur-2xl md:hidden"
